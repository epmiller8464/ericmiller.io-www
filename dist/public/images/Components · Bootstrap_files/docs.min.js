...
function AnchorJS(a) {
  ...
  function b(a) {
    ...
    var b;if ("string" == typeof a || a instanceof String) b = [].slice.call(document.querySelectorAll(a));else {
      if (!(Array.isArray(a) || a instanceof NodeList)) throw new Error("The selector provided to AnchorJS was invalid.");b = [].slice.call(a);
    }return b;
  }function d() {
    ...
    var e,
        ...
        o,
        p,
        q = [];if (b(this.options), p = this.options.visible, "touch" === p && (p = this.isTouchDevice() ? "always" : "hover"), a || (a = "h1, h2, h3, h4, h5, h6"), e = c(a), 0 === e.length) return !1;for (d(), f = document.querySelectorAll("[id]"), g = [].map.call(f, function (a) {
      return a.id;
    }), i = 0; i < e.length; i++) {
      if (this.hasAnchorJSLink(e[i])) q.push(i);else {
        if (e[i].hasAttribute("id")) h = e[i].getAttribute("id");else {
          l = this.urlify(e[i].textContent), m = l, k = 0;do {
            void 0 !== j && (m = l + "-" + k), j = g.indexOf(m), k += 1;
          } while (-1 !== j);j = void 0, g.push(m), e[i].setAttribute("id", m), h = m;
    ...
    var c,
        d = /[& +$,:;=?@"#{}|^~[`%!'\]\.\/\(\)\*\\]/g;return this.options.truncate || b(this.options), c = a.trim().replace(/\'/gi, "").replace(d, "-").replace(/-{2,}/g, "-").substring(0, this.options.truncate).replace(/^-+|-+$/gm, "").toLowerCase();
  }, this.hasAnchorJSLink = function (a) {
    var b = (" " + a.firstChild.className + " ").indexOf(" anchorjs-link ") > -1,
        c = (" " + a.lastChild.className + " ").indexOf(" anchorjs-link ") > -1;return b || c;
  };
}!function (a, b) {
  ...
  return function (a) {
      ...
      function d(a, b, c, d) {
        ...
        t(function () {
          ...
          a = a || {};var c = {},
              ...
              i = D(g.bgnodes),
              j = D(g.stylenodes),
              k = D(g.objects);c.stylesheets = [], c.svgXMLStylesheet = !0, c.noFontFallback = !!g.noFontFallback && g.noFontFallback;for (var l = 0; l < j.length; l++) {
    ...
    (function (a) {
      b.extend = function (a, b) {
        ...
        var b = { height: a.clientHeight, width: a.clientWidth };return !(!b.height || !b.width) && b;
      };
    }).call(b, function () {
      return this;
    }());
