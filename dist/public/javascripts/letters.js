...
Letters.prototype = {
    ...
    drawLetter: function drawLetter(letter, index, size, weight, rounded, color, fade) {
        if (letter === ' ') {
    ...
    createSVG: function createSVG(svgSize, letter, weight, index, size, fade) {
    ...
    setupFade: function setupFade(fade, index) {
    ...
    initAlphabet: function initAlphabet(weight, rounded) {
        var width = 44 + weight;
        ...
        this.alphabet = {
            ...
            'ł': {
                ...
                final: [{ begin: p50plusRW, end: p50plusRW }, { begin: '0%', end: '75%' }]
            },
            'm': {
                svg: svgLarge,
            ...
            'ń': {
                ...
                final: [{ begin: '-25%', end: '50%' }, { begin: p50plusRW, end: p50plusRW }, { begin: '0%', end: '75%' }]
            },
            'o': {
                svg: svgSmall,
                paths: [circleCenter],
