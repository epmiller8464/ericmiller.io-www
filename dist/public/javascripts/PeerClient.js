...
function userJoined(data) {
  var html = '<li class="list-group-item" style="font-size: 0.75em;">' + '    <h6 class="pull-left">' + data.username + '</h6>' + '    <span style="padding-top: 10px; padding-left: 10px;"' + '          class="glyphicon glyphicon-heart text-success"></span>' + '</li>';
  $('#peers').prepend(html);
}
