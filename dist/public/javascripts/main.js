...
;(function (window) {
  ...
  GridLoaderFx.prototype.effects = {
    ...
    'Amun': {
      ...
      sortTargetsFn: function sortTargetsFn(a, b) {
    ...
    'Ra': {
      ...
      animeOpts: {
        ...
        translateY: [400, 0],
        scaleY: [{ value: [3, 0.6], delay: function delay(t, i) {
            return i * 100 + 120;
          }, duration: 300, easing: 'easeOutExpo' }, { value: [0.6, 1], duration: 1400, easing: 'easeOutElastic' }],
        scaleX: [{ value: [0.9, 1.05], delay: function delay(t, i) {
            return i * 100 + 120;
          }, duration: 300, easing: 'easeOutExpo' }, { value: [1.05, 1], duration: 1400, easing: 'easeOutElastic' }]
      }
    },
    'Sobek': {
      animeOpts: {
    ...
    'Nut': {
      ...
      animeRevealerOpts: {
        ...
        translateX: [{ value: ['101%', '0%'], duration: 400 }, { value: ['0%', '-101%'], duration: 400 }]
      },
      animeOpts: {
        duration: 900,
        easing: 'easeOutCubic',
