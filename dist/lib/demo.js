...
var items = [].slice.call(document.querySelectorAll('ul.list > li.list__item'))(function init() {
  items.forEach(function (item, pos) {
    ...
    instance = new Letters(word, options[pos]),
        endPlayCallback = function endPlayCallback() {
    ...
    playCtrl.addEventListener('click', function () {
      ...
      if (pos === 6) {
        // showcase how to undraw with an animation
        instance.hide({
